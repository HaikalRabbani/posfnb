  ...
  <div class="min-h-screen flex items-center justify-center bg-surface p-4">
    <div class="bg-white p-8 rounded-3xl shadow-xl w-full max-w-md border border-border">
      ...
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-muted font-medium mt-1">Masuk ke panel kasir & admin</p>
      </div>
...
const handleLogin = async () => {
  ...
  try {
    ...
    if (token) {
      ...
      // SIMPAN EMAIL YANG BERHASIL LOGIN KE LOCAL STORAGE
      ...
      try {
        ...
        console.warn('Gagal ambil data user awal');
      }
